      ...
      <div className="w-full max-w-md bg-[#161b22] border border-[#21262d] rounded-2xl p-8 shadow-2xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-[#8b949e]">build.nvidia.com → Settings → API Keys</p>
          </div>
        </div>

        <div className="mb-5 p-3 bg-[#76b900]/5 border border-[#76b900]/15 rounded-lg flex items-center justify-between">
          <span className="text-xs font-mono text-[#76b900]">qwen/qwen2.5-vl-72b-instruct</span>
          <span className="text-xs text-[#8b949e]">Vision · 72B</span>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            ...
            Pobierz klucz na build.nvidia.com
          </a>
